...
from .routers import auth, depots, users, plv_prices
...
app.include_router(plv_prices.public_router, prefix="/api")
app.include_router(plv_prices.admin_router, prefix="/api")
